...
public interface CartRvRepository extends CrudRepository<CartRv, Long> {
	...
	CartRv getCartRvMedecinJourByCreneau(String matricule, @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) Date jour, Long idclient, Long idcreneau);
	...
	List<CartRv> getCartRvMedecinJour(String matricule, @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) Date jour, Long idclient);
