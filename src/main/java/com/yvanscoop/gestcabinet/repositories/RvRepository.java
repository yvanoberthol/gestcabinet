...
public interface RvRepository extends CrudRepository<Rv, Long> {
	...
	List<Rv> getRvMedecinJour(String matricule,@DateTimeFormat(iso = DateTimeFormat.ISO.DATE) Date jour);
	...
	List<Rv> getRvMedecinJourPris(String matricule,@DateTimeFormat(iso = DateTimeFormat.ISO.DATE) Date date);
